<section id="work" class="relative z-10 flex md:min-h-dvh flex-col px-6 py-20 md:py-40">
  <div class="mx-auto w-full max-w-[1360px] flex flex-1 flex-col gap-8 md:gap-15">
    <div class="grid grid-cols-6 gap-6 md:grid-cols-12 md:items-start">
      <p class="col-span-6 md:col-span-12 font-mono text-xs uppercase text-ink-secondary" data-reveal>Origon</p>

      <h2
        data-split-text
        class="col-span-6 md:col-span-5 text-4xl md:text-6xl font-semibold leading-none tracking-tight text-pretty"
      >
        An enterprise platform for AI agents
      </h2>
      ...
      <div class="col-span-6 md:col-span-4 md:col-start-9 grid grid-cols-subgrid gap-6">
        ...
        >
          Designed the platform and built key frontend features for an
          enterprise tool to create and operate multi-agent AI systems at scale.
        </p>
        <a
          href="https://origon.ai"
          target="_blank"
    ...
    <enhanced:img
      src="$lib/assets/media/origon-dashboard.png"
